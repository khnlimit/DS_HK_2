...
#
# curl https://raw.githubusercontent.com/UnataInc/pycon2013/master/data/ml-1m/ratings.dat > ../../../data/ml-1m-ratings.dat
#
...
def ex1(dat_file=DATA_DIR + 'ml-1m-ratings.dat',
        pct_train=0.5):
